...
<section id="content">
	...
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=099493c9c29b0d0290bce46d3ce00ff1&redirect_uri=http://localhost/mvc/member/enroll/kakao">
	...
	<h3>로그인</h3>
	<!-- REST API 키 =  client_id -->
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=099493c9c29b0d0290bce46d3ce00ff1&redirect_uri=http://localhost/mvc/kakaoLogin">
